...
name: forge-sec
version: 1.0.0
description: Genera código seguro por construcción usando el compilador FORGE-SEC. Escribe la intención en .fs, compila a PHP/Python/Java/Rust y garantiza ausencia de SQL Injection, XSS y CSRF antes de desplegar.
author: Luis Reina / AGX OSINT S.L.
repository: https://github.com/Nexoluis/forge-sec
tags: [security, compiler, php, python, java, rust, sql-injection, xss, csrf, owasp]
---
...
- Garantizar que no hay SQL Injection, XSS o CSRF en el código generado
...
### 1. Escribir la intención en FORGE-SEC

Escribe el programa en sintaxis `.fs` con tipos de seguridad correctos y efectos declarados:
...
**Tipos de seguridad disponibles:**
...
# Solo verificar sin generar código
python3 forge_sec_cli.py check archivo.fs
...
2. El security report con garantías por mecanismo:
...
*FORGE-SEC — Lo inseguro no debe ser expresable. Lo seguro debe ser lo natural.*
